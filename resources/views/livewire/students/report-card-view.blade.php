    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="overflow-hidden shadow-xl sm:rounded-lg">
        ...
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
          ...
          <div class="mt-4">{{ $subject_grades->links() }}</div>
    ...
    <x-slot name="content">
      <div class="col-span-6 sm:col-span-4 mt-3">
        ...
        <x-jet-input id="subject_name" type="text" class="mt-1 block w-full"
          wire:model.defer="subject_name" />
        <x-jet-input-error for="subject_name" class="mt-2" />
      </div>

      <div class="grid grid-cols-2 gap-8 mt-3">
        <div class="">
          <x-jet-label for="mark" value="{{ __('Mark') }}" />
          <x-jet-input id="mark" type="number" class="mt-1 block w-full"
            wire:model.defer="mark" />
          <x-jet-input-error for="mark" class="mt-2" />
        </div>

        <div class="">
          <x-jet-label for="grade" value="{{ __('Grade') }}" />
          <x-jet-input id="grade" type="text" class="mt-1 block w-full"
